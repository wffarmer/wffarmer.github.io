...
hamburger.addEventListener("click", () => {
  ...
  content.style.paddingTop = (60 + disclaimerHeight) + 'px';
  p.style.paddingTop = (50 + disclaimerHeight) + 'px';
})
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (disclaimer.style.display === "flex") {
    content.style.paddingTop = `${disclaimer.clientHeight + 60}px`;
    p.style.paddingTop = `${disclaimer.clientHeight + 50}px`;
  } else {
    content.style.paddingTop = "60px"; // Default padding-top value
    p.style.paddingTop = "50px";
  }
});
