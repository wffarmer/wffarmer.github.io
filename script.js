...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (disclaimer.style.display === "flex") {
    content.style.paddingTop = `${disclaimer.clientHeight + 160}px`; // Adjust this value as needed
  } else {
    content.style.paddingTop = "160px"; // Default padding-top value
  }
});
...
window.addEventListener('resize', function() {
  ...
  content.style.paddingTop = (160 + disclaimerHeight) + 'px';
});
